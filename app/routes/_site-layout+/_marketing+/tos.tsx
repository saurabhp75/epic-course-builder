export default function TermsOfServiceRoute() {
	return (
		<div>
			<div className="mb-2">
				<h3 className="font-regular max-w-xl text-left text-2xl tracking-tighter">
			...
			<div className="mb-2">
				...
				<p>
					Welcome to EpicCourse, operated by Saurabh Prakash and our team
					("Company", “us”, “we”, or “our”)! Below are our Terms of Service, we
					invite you to carefully read the following pages. It will take you
					approximately 5 minutes. These Terms of Service (“Terms”, “Terms of
					Service”) govern your use of our web pages located at
					https://epicsaas.dev/ operated by EpicCourse. Our Privacy Policy also
					governs your use of our Service and explains how we collect, safeguard
					and disclose information that results from your use of our web pages.
					Please read it here https://epicsaas.dev/privacy. Your agreement with
					us includes these Terms and our Privacy Policy (“Agreements”). You
					acknowledge that you have read and understood Agreements, and agree to
					be bound of them. If you do not agree with (or cannot comply with)
					Agreements, then you may not use the Service, but please let us know
					by emailing at support@epicsaas.dev so we can try to find a solution.
			...
			<div className="mb-2">
				...
				<p>
					...
					other reasons. We reserve the right to modify the number of words
					charged for the output or input or impose any usage restrictions per
					hour, regardless of what was previously committed at the time of
					subscription. These changes will be made according to our model
					capacity to safeguard the interests of all users and to ensure uniform
					access to the service. We take this step to provide equal opportunity
					to every user and protect the quality of our service. We reserve the
			...
			<div className="mb-2">
				...
				<p>
					...
					end of each Billing Cycle, your Subscription will automatically renew
					under the exact same conditions unless you cancel it or EpicCourse
					cancels it. You may cancel your Subscription renewal either through
					your online account management page or by contacting EpicCourse
					customer support team. A valid payment method, including credit card
					or PayPal, is required to process the payment for your subscription.
					You shall provide EpicCourse with accurate and complete billing
					...
					payment information, you automatically authorize EpicCourse to charge
					...
					reason, EpicCourse will issue an electronic invoice indicating that
			...
			<div className="mb-2">
				...
				<p>
					EpicCourse may, at its sole discretion, offer a Subscription with a
					...
					for Free Trial, you will not be charged by EpicCourse until Free Trial
					...
					selected. At any time and without notice, EpicCourse reserves the
			...
			<div className="mb-2">
				...
				<p>
					EpicCourse, in its sole discretion and at any time, may modify
					Subscription fees for the Subscriptions. Any Subscription fee change
					will become effective at the end of the then-current Billing Cycle. At
					any time and without notice, EpicCourse reserves the right to (i)
					modify Terms of Service of Free Trial offer, or (ii) cancel such Free
					Trial offer. Your continued use of Service after Subscription fee
			...
			<div className="mb-2">
				...
				<p>
					EpicCourse is committed to providing high-quality, reliable service
					...
					utilizing our business API. The vast majority of users (over 95%)
					consistently operate within the defined parameters. Exceeding these
					parameters could lead to restricted or reduced service access, with or
					without prior warning. Our system diligently monitors for automated or
					robotic behavior to maintain service safety and quality. Please be
					aware that sharing login details of unlimited accounts for monetary
					gains is considered illegal. Each seat is intended for one individual
					user only, and multiple users sharing one account are not permitted.
					Warning: Please note that unusually high usage or sharing of login
					details could lead to account suspension or deletion without prior
					notice, with no possibility for refunds.
				</p>
			</div>
			<div className="mb-2">
				<h3 className="font-regular max-w-xl text-left text-2xl tracking-tighter">
				...
				<p>
					...
					otherwise. To transmit, or procure the sending of, any advertising or
					promotional material, including any “junk mail”, “chain letter,”
					“spam,” or any other similar solicitation. To impersonate or attempt
					to impersonate Company, a Company employee, another user, or any other
					person or entity. In any way that infringes upon the rights of others,
					or in any way is illegal, threatening, fraudulent, or harmful, or in
					connection with any unlawful, illegal, fraudulent, or harmful purpose
					or activity. To engage in any other conduct that restricts or inhibits
					...
					liability. Additionally, you agree not to: Use Service in any manner
					that could disable, overburden, damage, or impair Service or interfere
					with any other party’s use of Service, including their ability to
					engage in real time activities through Service. Use any robot, spider,
					...
					Service. Use any manual process to monitor or copy any of the material
					on Service or for any other unauthorized purpose without our prior
					written consent. Use any device, software, or routine that interferes
					with the proper working of Service. Introduce any viruses, trojan
					...
					which Service is stored, or any server, computer, or database
					connected to Service. Attack Service via a denial-of-service attack or
					a distributed denial-of-service attack. Take any action that may
					damage or falsify Company rating. Otherwise attempt to interfere with
			...
			<div className="mb-2">
				...
				<p>
					...
					property of EpicCourse and its licensors. Service is protected by
			...
			<div className="mb-2">
				...
				<p>
					...
					support@epicsaas.dev, with the subject line: “Copyright Infringement”
			...
			<div className="mb-2">
				...
				<p>
					...
					the material that you claim is infringing is located; your address,
					...
					the copyright owner's behalf. You can contact our team via email at
					support@epicsaas.dev Error Reporting and Feedback You may provide us
					either directly at support@epicsaas.dev or via third party sites and
			...
			<div className="mb-2">
				...
				<p>
					...
					that are not owned or controlled by EpicCourse has no control over,
			...
			<div className="mb-2">
				...
				<p>
					...
					them. Contact Us You can contact us by emailing to:
					support@epicsaas.dev for any queries.
				</p>
			</div>
		</div>
	)
