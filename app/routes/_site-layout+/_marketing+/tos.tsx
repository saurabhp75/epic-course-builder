export default function TermsOfServiceRoute() {
	return (
		<div>
			...
			<p>
				Terms and Conditions By continuing to use our platform, you agree to
				these terms and conditions.
			</p>
			<h3>Introduction</h3>
			<p>
				Welcome to EpicCourse, operated by Saurabh Prakash and our team ("Company",
				“us”, “we”, or “our”)! Below are our Terms of Service, we invite you to
				carefully read the following pages. It will take you approximately 5
				minutes. These Terms of Service (“Terms”, “Terms of Service”) govern
				your use of our web pages located at https://epicsaas.dev/ operated by
				EpicCourse. Our Privacy Policy also governs your use of our Service and
				...
				https://epicsaas.dev/privacy. Your agreement with us includes these
				Terms and our Privacy Policy (“Agreements”). You acknowledge that you
				...
				support@epicsaas.dev so we can try to find a solution. These Terms apply
			...
			<p>
				...
				modify the number of words charged for the output or input or impose any
				usage restrictions per hour, regardless of what was previously committed
				at the time of subscription. These changes will be made according to our
				model capacity to safeguard the interests of all users and to ensure
				uniform access to the service. We take this step to provide equal
				opportunity to every user and protect the quality of our service. We
			...
			<p>
				...
				monthly or quarterly or annual basis, depending on the type of
				subscription plan you select when purchasing a Subscription. At the end
				of each Billing Cycle, your Subscription will automatically renew under
				the exact same conditions unless you cancel it or EpicCourse cancels it.
				You may cancel your Subscription renewal either through your online
				account management page or by contacting EpicCourse customer support team.
				A valid payment method, including credit card or PayPal, is required to
				process the payment for your subscription. You shall provide EpicCourse
				...
				authorize EpicCourse to charge all Subscription fees incurred through your
				account to any such payment instruments. Should automatic billing fail
				to occur for any reason, EpicCourse will issue an electronic invoice
			...
			<h3>Free Trial</h3>
			<p>
				EpicCourse may, at its sole discretion, offer a Subscription with a free
				trial for a limited period of time (“Free Trial”). You may be required
				to enter your billing information in order to sign up for Free Trial. If
				you do enter your billing information when signing up for Free Trial,
				you will not be charged by EpicCourse until Free Trial has expired. On the
				...
				the type of Subscription you have selected. At any time and without
				notice, EpicCourse reserves the right to (i) modify Terms of Service of
				Free Trial offer, or (ii) cancel such Free Trial offer.
			</p>
			<h3>Fee Changes</h3>
			<p>
				EpicCourse, in its sole discretion and at any time, may modify Subscription
				fees for the Subscriptions. Any Subscription fee change will become
				effective at the end of the then-current Billing Cycle. At any time and
				without notice, EpicCourse reserves the right to (i) modify Terms of
				Service of Free Trial offer, or (ii) cancel such Free Trial offer. Your
			...
			<p>
				EpicCourse is committed to providing high-quality, reliable service for all
				users. We expect all our users to avoid misuse or overuse of our
				services. Overuse by one user may impact the quality of service for
				others. Users are encouraged to select plans that align with their
				professional needs and business size. High-usage users should consider
				upgrading to a more robust plan, requesting a custom plan, or utilizing
				our business API. The vast majority of users (over 95%) consistently
				operate within the defined parameters. Exceeding these parameters could
				lead to restricted or reduced service access, with or without prior
				warning. Our system diligently monitors for automated or robotic
				behavior to maintain service safety and quality. Please be aware that
				sharing login details of unlimited accounts for monetary gains is
				considered illegal. Each seat is intended for one individual user only,
				and multiple users sharing one account are not permitted. Warning:
				Please note that unusually high usage or sharing of login details could
				lead to account suspension or deletion without prior notice, with no
			...
			<p>
				...
				applicable national or international law or regulation. For the purpose
				of exploiting, harming, or attempting to exploit or harm minors in any
				way by exposing them to inappropriate content or otherwise. To transmit,
				...
				Company employee, another user, or any other person or entity. In any
				...
				illegal, fraudulent, or harmful purpose or activity. To engage in any
				...
				users of Service or expose them to liability. Additionally, you agree
				not to: Use Service in any manner that could disable, overburden,
				...
				through Service. Use any robot, spider, or other automatic device,
				process, or means to access Service for any purpose, including
				monitoring or copying any of the material on Service. Use any manual
				process to monitor or copy any of the material on Service or for any
				...
				Service. Introduce any viruses, trojan horses, worms, logic bombs, or
				other material which is malicious or technologically harmful. Attempt to
				...
				computer, or database connected to Service. Attack Service via a
				denial-of-service attack or a distributed denial-of-service attack. Take
				any action that may damage or falsify Company rating. Otherwise attempt
				to interfere with the proper working of Service.
			</p>
			<h3>Analytics</h3>
			<p>
				We may use third-party Service Providers to monitor and analyze the use
				of our Service. You can check our privacy policy to know what tools we
				use.
			</p>
			...
			<p>
				...
				EpicCourse and its licensors. Service is protected by copyright, trademark,
				and other laws of the United States and foreign countries. Our
				trademarks and trade dress may not be used in connection with any
				product or service without the prior written consent of EpicCourse.
			</p>
			...
			<p>
				...
				via email to support@epicsaas.dev, with the subject line: “Copyright
			...
			<p>
				...
				behalf of the owner of the copyright's interest; a description of the
				...
				exists or a copy of the copyrighted work; identification of the URL or
				...
				contact our team via email at support@epicsaas.dev Error Reporting and
				Feedback You may provide us either directly at support@epicsaas.dev or
			...
			<p>
				...
				are not owned or controlled by EpicCourse has no control over, and
				...
				You acknowledge and agree that EpicCourse shall not be responsible or
			...
			<p>
				...
				Contact Us You can contact us by emailing to: support@epicsaas.dev for
				any queries.
			</p>
		</div>
	)
