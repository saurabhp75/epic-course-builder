		...
		<div>
			...
			<div className="mb-2">
				...
				<p>
					...
					“we”, or “our”) operates https://epicsaas.dev/ (hereinafter referred
					to as “Service”). Our Privacy Policy governs your visit to
					https://epicsaas.dev/, and explains how we collect, safeguard, and
					disclose information that results from your use of our Service. By
			...
			<div className="mb-2">
				...
				<p>
					...
					name Cookies and Usage Data We may use your Personal Data to contact
					...
					the unsubscribe link or by emailing at support@EpicCourse.app.
				</p>
			</div>
			<div className="mb-2">
				<h3 className="font-regular max-w-xl text-left text-2xl tracking-tighter">
				...
				<p>
					...
					other diagnostic data. We use cookies and similar tracking
					...
					Cookies we use: Session Cookies: We use Session Cookies to operate our
					Service. Preference Cookies: We use Preference Cookies to remember
					your preferences and various settings. Security Cookies: We use
					Security Cookies for security purposes. Advertising Cookies:
			...
			<div className="mb-2">
				...
				<p>
					...
					agreement to that transfer. EpicCourse will take all the steps
			...
			<div className="mb-2">
				...
				<p>
					...
					your Personal Data may be transferred. Other cases. We may disclose
					your information also: to fulfill the purpose for which you provide
					it; for the purpose of including your company’s logo on our website;
			...
			<div className="mb-2">
				...
				<p>
					...
					– See more at https://eur-lex.europa.eu/eli/reg/2016/679/oj We aim to
					take reasonable steps to allow you to correct, amend, delete, or limit
					the use of your Personal Data. If you wish to be informed what
					Personal Data we hold about you and if you want it to be removed from
					our systems, please email us at support@EpicCourse.app. In certain
					circumstances, you have the following data protection rights: the
					right to access, update, or delete the information we have on you; the
					right of rectification. You have the right to have your information
					...
					Personal Data; the right of restriction. You have the right to request
					that we restrict the processing of your personal information; the
					right to data portability. You have the right to be provided with a
					...
					Please note that we may not be able to provide Service without some
			...
			<div className="mb-2">
				...
				<p>
					...
					site anonymously; our Privacy Policy link includes the word “Privacy”,
					and can easily be found on the page specified above on the home page
					of our website; users will be notified of any privacy policy changes
					on our Privacy Policy Page; users are able to change their personal
					information by emailing us at support@EpicCourse.app.{' '}
				</p>
			</div>
			<div className="mb-2">
				<h3 className="font-regular max-w-xl text-left text-2xl tracking-tighter">
			...
			<div className="mb-2">
				<h3 className="font-regular max-w-xl text-left text-2xl tracking-tighter">
					Other Tools Tool Privacy Policy{' '}
				</h3>
				<p>
					Open AI https://openai.com/policies/privacy-policy Pinecone
					https://www.pinecone.io/privacy/ Fauna https://fauna.com/privacy
					Vercel https://vercel.com/legal/privacy-policy Cloudflare
			...
			<div className="mb-2">
				...
				<p>
					...
					Google Inc. You can opt-out of Google Analytics for Display
			...
			<div className="mb-2">
				...
				<p>
					...
					https://www.facebook.com/help/164968693837950 To opt-out from
					Facebook's interest-based ads, follow these instructions from
			...
			<div className="mb-2">
				...
				<p>
					Lemon Squeezy is our merchant of record. Their privacy policy can be
					viewed at https://www.lemonsqueezy.com/privacy{' '}
				</p>
			</div>
			<div className="mb-2">
				<h3 className="font-regular max-w-xl text-left text-2xl tracking-tighter">
