export default function PrivacyRoute() {
	return (
		<div>
			<h3>Privacy</h3>
			<p>
				By continuing to use our platform, you agree that you read the privacy
				policy.
			</p>
			<h3>Introduction </h3>
			<p>
				EpicCourse, operated by Saurabh Prakash and our team (“Company”, “us”,
				“we”, or “our”) operates https://epicsaas.dev/ (hereinafter referred to
				as “Service”). Our Privacy Policy governs your visit to
				https://epicsaas.dev/, and explains how we collect, safeguard, and
				disclose information that results from your use of our Service. By using
			...
			<h3>Definitions</h3>
			<p>
				Service means the https://epicsaas.dev/ website operated by sorablue.
			...
			<p>
				...
				Cookies and Usage Data We may use your Personal Data to contact you with
				...
				or by emailing at support@EpicCourse.app.
			</p>
			<h3>Personal Data</h3>
			<p>
			...
			<h3>Use of Data</h3>
			<p>EpicCourse uses the collected data for various purposes:</p>
			<h3>Personal Data</h3>
			<p>
				to provide and maintain our Service; to notify you about changes to our
				Service; to allow you to participate in interactive features of our
				Service when you choose to do so; to provide customer support; to gather
				analysis or valuable information so that we can improve our Service; to
				monitor the usage of our Service; to detect, prevent and address
				technical issues; to fulfill any other purpose for which you provide it;
				to carry out our obligations and enforce our rights arising from any
				contracts entered into between you and us, including for billing and
				collection; to provide you with notices about your account and/or
				...
				enquired about unless you have opted not to receive such information; in
				any other way we may describe when you provide the information; for any
			...
			<p>
				...
				note that we may transfer the data, including Personal Data, to United
				...
				agreement to that transfer. EpicCourse will take all the steps reasonably
				necessary to ensure that your data is treated securely and in accordance
				with this Privacy Policy, and no transfer of your Personal Data will
				take place to an organisation or a country unless there are adequate
			...
			<p>
				...
				requests by public authorities. Business Transaction. If we or our
				subsidiaries are involved in a merger, acquisition, or asset sale, your
				Personal Data may be transferred. Other cases. We may disclose your
				information also: to fulfill the purpose for which you provide it; for
				the purpose of including your company’s logo on our website; for any
				other purpose with your consent.
			</p>
			...
			<p>
				...
				use of your Personal Data. If you wish to be informed what Personal Data
				we hold about you and if you want it to be removed from our systems,
				please email us at support@EpicCourse.app. In certain circumstances, you
				have the following data protection rights: the right to access, update,
				or delete the information we have on you; the right of rectification.
				You have the right to have your information rectified if that
				information is inaccurate or incomplete; the right to object. You have
				the right to object to our processing of your Personal Data; the right
				of restriction. You have the right to request that we restrict the
				processing of your personal information; the right to data portability.
				You have the right to be provided with a copy of your Personal Data in a
				structured, machine-readable, and commonly used format; the right to
				withdraw consent. You also have the right to withdraw your consent at
				any time where we rely on your consent to process your personal
				information; Please note that we may ask you to verify your identity
				before responding to such requests. Please note that we may not be able
				to provide Service without some necessary data. You have the right to
				complain to a Data Protection Authority about our collection and use of
				your Personal Data. For more information, please contact your local data
			...
			<p>
				...
				anonymously; our Privacy Policy link includes the word “Privacy”, and
				can easily be found on the page specified above on the home page of our
				website; users will be notified of any privacy policy changes on our
				Privacy Policy Page; users are able to change their personal information
				by emailing us at support@EpicCourse.app.{' '}
			</p>
			<h3>Our Policy on “Do Not Track” Signals: </h3>
			<p>
				According to CalOPPA, we agree to the following: We honor Do Not Track
				signals and do not track, plant cookies, or use advertising when a Do
				Not Track browser mechanism is in place. Do Not Track is a preference
				you can set in your web browser to inform websites that you do not want
				to be tracked. You can enable or disable Do Not Track by visiting the
			...
			<h3>Other Tools Tool Privacy Policy </h3>
			<p>
				Open AI https://openai.com/policies/privacy-policy Pinecone
				https://www.pinecone.io/privacy/ Fauna https://fauna.com/privacy Vercel
				https://vercel.com/legal/privacy-policy Cloudflare
				https://www.cloudflare.com/privacypolicy/ Railway
				https://railway.app/legal/privacy GitHub
				https://docs.github.com/en/site-policy/privacy-policies/github-privacy-statement
				Truto https://truto.one/privacy Carbon https://carbon.ai/privacy
				ChartMogul https://chartmogul.com/privacy Rewardful
				https://www.rewardful.com/privacy Tolt https://tolt.io/privacy-policy
				Scraping Bee https://www.scrapingbee.com/privacy-policy/ Logsnag
				https://logsnag.com/privacy PostHog https://posthog.com/privacy Bunny
				https://bunny.net/privacy/ SaaSync
				https://www.saasync.com/privacy-policy/ Featurebase
				https://www.featurebase.app/privacy-policy Baselime
				https://baselime.io/privacy
			</p>
			<h3>Behavioral Remarketing</h3>
			<p>
				EpicCourse may use remarketing services to advertise on third party
			...
			<h3> Google</h3>
			<p>
				Ads (AdWords) Google Ads (AdWords) remarketing service is provided by
				...
				Settings page: http://www.google.com/settings/ads Google also recommends
				...
				https://policies.google.com/privacy?hl=en For more information on the
				privacy practices of Google, please visit the Google Privacy Terms web
				page: http://www.google.com/settings/ads
			</p>
			<h3>Facebook</h3>
			<p>
				Facebook remarketing service is provided by Facebook Inc. Facebook
				remarketing service is provided by Facebook Inc. You can learn more
				about interest-based advertising from Facebook by visiting this page:
				https://www.facebook.com/help/164968693837950 To opt-out from Facebook's
				interest-based ads, follow these instructions from Facebook:
				https://www.facebook.com/help/568137493302217 Facebook adheres to the
				...
				your mobile device settings. For more information on the privacy
			...
			<p>
				...
				by email: support@EpicCourse.app.
			</p>
		</div>
	)
}
