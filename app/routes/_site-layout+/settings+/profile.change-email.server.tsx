...
} from '#app/routes/_site-layout+/_auth+/verify.server.ts'
...
export function EmailChangeEmail({
	...
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Epic Course Email Change</E.Text>
				</h1>
				<p>
					<E.Text>
...
function EmailChangeNoticeEmail({ userId }: { userId: string }) {
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Your Epic Course email has been changed</E.Text>
				</h1>
				<p>
					<E.Text>
						We're writing to let you know that your Epic Course email has been
						changed.
					</E.Text>
				</p>
				<p>
